        ...
        <div class="home">
            ...
            <div class="admin-dashbord container">
                ...
                if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST["user_id"]) && isset($_POST["status"])) {
                    include $_SERVER['DOCUMENT_ROOT'] . "/rifna-sem-4-project/page/admin-dashbord/table/db_conn.php"; // Include database connection file
                ...
                if (isset($_GET["id"])) {
                    ...
                    include $_SERVER['DOCUMENT_ROOT'] . "/rifna-sem-4-project/page/admin-dashbord/table/db_conn.php";
